 ...
 * Handles Google's redirect, exchanges code for tokens, fetches user info,
 * upserts into users table, writes session, and redirects back to SPA.
 */
